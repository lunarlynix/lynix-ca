...
function Navbar(props) {
  /* Auth */
  /* Authentication is Diabled due to crticial CVEs */
  const user = null;
      ...
      <div className={navBg ? 'fixed w-full text-gray-700 text-gray-200 bg-bgray-bg border-b border-gray-700 z-50' : 'fixed w-full text-gray-700 text-gray-200 z-50 bg-bgray-bg bg-opacity-0 '}>
        ...
        >
          <div className="flex flex-row items-center justify-between p-4">
            ...
            >
              <p className="my-auto"><i class="fa-solid fa-lock text-blue-700"></i> LynixSec</p>
            </a>
            <button
...
<hr class="py-2 mt-2 mx-2 border-gray-600"/>
            ...
            <div className="relative my-auto">
              <a href="/login" className="bg-blue-700 flex flex-row items-center w-full px-4 py-2 mt-2 text-sm font-semibold text-left rounded-full md:w-auto md:inline md:mt-0 md:ml-4">
                <span>
